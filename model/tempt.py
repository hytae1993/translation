...
class DecoderImage(nn.Module):
    def __init__(self, n_channels, n_classes, nearest=True):
        ...
        self.net_fg = DecoderImagePart(n_channels, n_classes, nearest=True)
        self.net_bg = DecoderImagePart(n_channels, n_classes, nearest=True)
